<template>
    <div>
        <el-form :model="form"  class="el-form--inline">
            ...
            <el-form-item label="书证号" :label-width="formLabelWidth">
                <el-input v-model="form.szh" auto-complete="off"></el-input>
            </el-form-item>
            ...
            <el-form-item label="书证日期" :label-width="formLabelWidth">
                <el-date-picker v-model="form.szsj" type="date" placeholder="选择日期"></el-date-picker>
            </el-form-item>
            ...
            <el-form-item label="审批内容" :label-width="formLabelWidth">
                <el-input type="textarea" v-model="form.splr" class="full"></el-input>
            </el-form-item>
